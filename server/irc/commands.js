    ...
    'PRIVMSG': function (command) {
        ...
        if ((command.trailing.charAt(0) === String.fromCharCode(1)) && (command.trailing.charAt(command.trailing.length - 1) === String.fromCharCode(1))) {
            ...
            if (command.trailing.substr(1, 6) === 'ACTION') {
                ...
                this.irc_connection.write('NOTICE ' + command.nick + ' :' + String.fromCharCode(1) + 'VERSION DigitalSands IRC Network' + String.fromCharCode(1));
            } else if (command.trailing.substr(1, 6) === 'SOURCE') {
                this.irc_connection.write('NOTICE ' + command.nick + ' :' + String.fromCharCode(1) + 'SOURCE http://iris.digitalsands.net/' + String.fromCharCode(1));
